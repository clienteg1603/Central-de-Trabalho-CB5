...
$historyFilterLayout.ColumnCount = 6
...
$historyFilterButton = New-Object Windows.Forms.Button
...
$schemaSearchLayout.ColumnCount = 5
...
$schemaSearchButton = New-Object Windows.Forms.Button
...
$schemaSearchLayout.Controls.Add($schemaOpenButton, 3, 0)
...
$schemaSearchLayout.Controls.Add($schemaRemoveButton, 4, 0)
...
$historyFilterButton.Add_Click({ Refresh-HistoryGrid })
...
$schemaSearchButton.Add_Click({ Refresh-SchematicGrid })
