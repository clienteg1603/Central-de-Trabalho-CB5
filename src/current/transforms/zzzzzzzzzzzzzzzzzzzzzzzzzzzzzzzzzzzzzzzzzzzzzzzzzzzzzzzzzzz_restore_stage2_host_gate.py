...
for a,b,l in [
('function Update-MaintenanceResponsiveLayout {\n    if ($script:MaintenanceResponsiveBusy -or $null -eq $form) { return }','function Update-MaintenanceResponsiveLayout {\n    if (Test-MaintenanceHostedLayoutRestoreGate) { return }\n    if ($script:MaintenanceResponsiveBusy -or $null -eq $form) { return }','maint responsive'),
